# vault-listing Specification

## Purpose
Ensure the vault's library and archived ("removed") tabs share a single definition of their filter
and sort behavior, so the two views apply identical logic and cannot silently diverge.
## Requirements
