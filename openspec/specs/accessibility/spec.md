...
## Purpose
Make the app usable with assistive technology: every interactive control has an accessible name,
modal dialogs manage keyboard focus (enter, trap, restore), and significant non-visual state changes
in the practice flow are announced via a live region.
## Requirements
